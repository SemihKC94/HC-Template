            ...
            else
            {
                ...
                else
                {
                    ...
                    for (int i = 0; i < spawnAmount; i++)
                    {
                        ...
                        if(platforms[spawnObj].GetComponent<Renderer>() != null)
                        {
                            boundX = platforms[spawnObj].GetComponent<Renderer>().bounds.size.x;
                            boundY = platforms[spawnObj].GetComponent<Renderer>().bounds.size.y;
                            boundZ = platforms[spawnObj].GetComponent<Renderer>().bounds.size.z;
                        ...
                        {
                            boundX = platforms[spawnObj].GetComponentInChildren<Renderer>().bounds.size.x;
                            boundY = platforms[spawnObj].GetComponentInChildren<Renderer>().bounds.size.y;
                            boundZ = platforms[spawnObj].GetComponentInChildren<Renderer>().bounds.size.z;
                        }
