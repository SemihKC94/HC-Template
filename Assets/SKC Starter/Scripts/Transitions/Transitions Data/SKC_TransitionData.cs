...
[CreateAssetMenu(fileName ="SKC_TransitionData",menuName ="SKC/Transition Data")]
public class SKC_TransitionData : ScriptableObject
{
    ...
    [HideInInspector] public float timeBetweenTransition,finishXpos,finishYpos,alpha, finishXpos2, finishYpos2, alphaDuration;
}
